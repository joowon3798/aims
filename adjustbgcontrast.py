...
# (*) Path to the target images to process
path = '/data/aims/STEM_Defect_Analysis_Data/rawSimImages/201222_correctLabels_befp/crop_Candidate3_ABC/'

# (*) Path to save the images
saveDir = '/data/aims/STEM_Defect_Analysis_Data/simImages/'
...
# Example2
ndpostproc = post_process(path, file_num, defect_list)
ndpostproc.read_image_and_label()
ndpostproc.rotate(3)
ndpostproc.crop(400, 400)
...
ndpostproc.save_as_image(saveDir, 3)
